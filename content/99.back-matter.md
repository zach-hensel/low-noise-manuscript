...
**Supplementary File S2**: Raw flow cytometry data, Python scripts required to reproduce Figures {@fig:pZH509-pJS101}, {@fig:pJS102-mean-noise}, and {@fig:pJS101-pDG101}, DNA sequences, and explanatory text files are available as a compressed archive at Zenodo [@doi:10.5281/zenodo.2671633].